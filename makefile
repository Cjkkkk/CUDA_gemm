...
DEP=$(CUDA_SOURCE)/encoding.cu $(CUDA_SOURCE)/encoding_in_reg.cu $(CUDA_SOURCE)/dense.cu $(CUDA_SOURCE)/sparse.cu $(CUDA_SOURCE)/quantization_int.cu $(CUDA_SOURCE)/quantization_float.cu
